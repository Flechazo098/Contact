...
public class EditableTextBox extends AbstractWidget {
    ...
    private Page createPage() {
        if (page.isEmpty()) {
            ...
            if (flag && mutableboolean.isTrue()) {
                ...
                point = new Point(this.font.width(page.substring(linesStartPos[line], selectionStart)), line * spacing);
            }
    ...
    private String getClipboardText() {
        return this.mc != null ? TextFieldHelper.getClipboardContents(this.mc) : "";
    }
    ...
    private void renderCursor(GuiGraphics guiGraphics, Point point, boolean isInsert) {
        if (this.updateCount / 6 % 2 == 0 && height != 0) {
            ...
            if (!isInsert) {
                guiGraphics.fill(point.x, point.y - 1, point.x + 1, point.y + 9, color);
            } else {
                guiGraphics.drawString(this.font, "_", point.x, point.y, color, false);
            }
        }
