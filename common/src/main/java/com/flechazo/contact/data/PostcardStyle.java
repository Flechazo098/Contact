...
public record PostcardStyle(
    ...
    public static PostcardStyle fromNBT(@Nullable CompoundTag tag) {
        ...
        if (tag.contains("Info", Tag.TAG_COMPOUND)) {
            ...
            return new PostcardStyle(
                    ...
                    new TradeInfo(true, new ItemStack(Items.EMERALD)),
                    new TextInfo(
                            info.getInt("PosX"), info.getInt("PosY"),
                            info.getInt("Width"), info.getInt("Height"),
                            colorInfo
                    ),
        ...
        if (tag.contains("CardID", Tag.TAG_STRING)) {
            ResourceLocation cardID = new ResourceLocation(tag.getString("CardID"));
    ...
    public static PostcardStyle fromItemStack(ItemStack stack) {
    ...
    public ResourceLocation getCardTexture() {
        ResourceLocation origin = new ResourceLocation(postcard.texture());
    ...
    public ResourceLocation getPostmarkTexture() {
        ResourceLocation origin = new ResourceLocation(postmark.texture());
        return new ResourceLocation(origin.getNamespace(), "textures/postcard/" + origin.getPath() + ".png");
    }
